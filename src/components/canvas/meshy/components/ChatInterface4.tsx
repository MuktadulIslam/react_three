...
export default function ChatInterface({ activeTab, onAddModelToSidebar, setActiveTab, onTabChange }: ChatInterfaceProps) {
    ...
    const generationTypeOptions: { value: GenerationType; label: string; description: string; icon: React.ReactNode }[] = [
        {
            value: 'text-to-3d',
            label: 'Text to 3D',
...
function getSuccessMessage(type: GenerationType, result: any, modelVersion: MeshyModelVersion): string {
